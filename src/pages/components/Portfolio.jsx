...
import p8 from '../../../public/assets/project.jpeg'
import p9 from '../../../public/assets/project.jpeg'
        ...
        {projects.map(({ id, image, title, github, demo }) => (
          ...
          className="max-w-lg flex shadow-lg shadow-gray-300 rounded-2xl overflow-hidden hover:scale-105 ease-in-out duration-200">
            ...
            <div className="w-1/3 flex flex-col items-center justify-evenly p-1">
              ...
              <a 
                className="text-4xl cursor-pointer duration-150 hover:text-[purple] hover:scale-110"
                href={github}
                target="_blank" 
              ...
              <a 
                className="text-4xl cursor-pointer duration-150  hover:text-green-700 hover:scale-110"
                href={demo}
                target="_blank" 
                rel="noopener noreferrer">
